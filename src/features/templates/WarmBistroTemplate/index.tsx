...
export default function WarmBistroTemplate({ tenant, menu, table, groups, tenantId }: MenuTemplateProps): ReactNode {
  useEffect(loadFonts, [])
  ...
  return (
    <div style={{ background: PAPER, minHeight: '100svh', color: INK, fontFamily: BODY, fontSize: tc.textScale }}>
      ...
      <nav className="sticky top-0 z-30" style={{ background: 'rgba(251,244,233,0.93)', backdropFilter: 'blur(10px)', borderBottom: `1px solid ${HAIR}` }}>
